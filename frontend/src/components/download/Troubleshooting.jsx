      ...
      a: (
        <div className="space-y-2">
          ...
          <ol className="list-decimal list-inside space-y-1.5 text-xs text-ro-text-primary bg-ro-bg/70 p-3 rounded-lg border border-ro-border">
            ...
            <li>
              Find the line: <code className="text-sky-300 font-mono">&lt;address&gt;54.253.142.107&lt;/address&gt;</code>
            </li>
            <li>
              Replace <code className="text-sky-300 font-mono">54.253.142.107</code> with the new Server IP displayed at the top of our website.
            </li>
